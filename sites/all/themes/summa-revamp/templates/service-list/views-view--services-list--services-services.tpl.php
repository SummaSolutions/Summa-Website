 ...
 */
drupal_add_css( drupal_get_path( "theme", "summa_revamp" ) . "/css/service-list-services/service-list.css" );
drupal_add_js( drupal_get_path( "theme", "summa_revamp" ) . "/js/service-list/skin.js" );
?>
<a name="what-we-do" class="anchor-target"></a>
...
<div class="path-container clearfix">
    <?php if ( $rows ): ?>
        <?php print $rows; ?>
    <?php endif; ?>
</div>
jQuery(document).ready(function () {
    ...
    if (jQuery(".case-study-slideshow .view-case-studies-details1 .view-content .views-row").length > 1) {
        var caseStudySlider = jQuery(".case-study-slideshow .view-case-studies-details1 .view-content").jCarrousel({easing:'easeOutBounce', duration:'2000', playInterval:3000, playDirection:"right"}).jCarrousel("play");
        jQuery("body.node-type-case-study .slider-arrow-left").live("click", function () {
            caseStudySlider.jCarrousel("stop");
            caseStudySlider.jCarrousel("prevSlide");
            return false;
        });
        jQuery("body.node-type-case-study .slider-arrow-right").live("click", function () {
            caseStudySlider.jCarrousel("stop");
            caseStudySlider.jCarrousel("nextSlide");
            return false;
        });
    }

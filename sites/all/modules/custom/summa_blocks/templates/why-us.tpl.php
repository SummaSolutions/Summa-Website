...
<div class="safe-container container">
    <div class="bxslider">
        <div class="slide">
            ...
            <div class="path only-mobile"><a href="<?php echo $base_url . '/company'; ?>"><?php echo t( "READ MORE" ); ?></a></div>
        </div>
        <div class="slide">
            <span>
    ...
    <div class="path only-tablet"><a href="<?php echo $base_url . '/company'; ?>"><?php echo t( "READ MORE" ); ?></a></div>
</div>